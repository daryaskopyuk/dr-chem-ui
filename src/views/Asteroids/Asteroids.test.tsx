...
describe('Asteroids', () => {
  ...
  test('should render loader while data is being loaded', () => {
    jest
      .spyOn(api, 'useGetAsteroidsQuery')
  ...
  test('should render error if data failed to load', () => {
    jest.spyOn(api, 'useGetAsteroidsQuery').mockImplementation(() => ({
      isLoading: false,
      error: 'error',
      refetch: () => {},
    }));
  ...
  test('should render data table when data is loaded', () => {
    jest.spyOn(api, 'useGetAsteroidsQuery').mockImplementation(() => ({
      isLoading: false,
